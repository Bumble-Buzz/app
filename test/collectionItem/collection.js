...
describe("AvaxTrade - Collection", () => {
  ...
  //     const collectionReflectionVault = await CONTRACT.connect(ACCOUNTS[0])._getCollectionReflectionVault(2);
  //     expect(collectionReflectionVault.length).to.be.equal(0);
  ...
  //     expect(await CONTRACT.connect(ACCOUNTS[0])._getCollectionIncentiveVault(2)).to.be.equal(0);
  ...
  //     const collectionReflectionVault = await CONTRACT.connect(ACCOUNTS[0])._getCollectionReflectionVault(2);
  //     expect(collectionReflectionVault.length).to.be.equal(100);
  ...
  //     await CONTRACT.connect(ACCOUNTS[0])._updateCollectionIncentiveVault(2, 33);
  //     expect(await CONTRACT.connect(ACCOUNTS[0])._getCollectionIncentiveVault(2)).to.be.equal(33);
  //   });
  ...
  //   });
  //   it('update collection - verified - new owner', async () => {
  //     let collectionIds = await CONTRACT.connect(ACCOUNTS[0])._getCollectionIds();
  //     expect(collectionIds[0].length).to.be.equal(2);
  ...
  //     expect(collectionIds[3].length).to.be.equal(1);
  //   });
  //   it('update collection - verified - new contract address', async () => {
  //     let collectionIds = await CONTRACT.connect(ACCOUNTS[0])._getCollectionIds();
  //     expect(collectionIds[0].length).to.be.equal(2);
  //     expect(collectionIds[1].length).to.be.equal(0);
  //     expect(collectionIds[2].length).to.be.equal(1);
