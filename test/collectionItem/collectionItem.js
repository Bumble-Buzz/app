...
describe("AvaxTrade - CollectionItem", () => {
  ...
  describe('Add item to collection', async () => {
  });
  ...
  describe('Public Functions', async () => {
    ...
    it('get items in collection - not empty - local', async () => {
      ...
      const result = await CONTRACT.connect(ACCOUNTS[0])._getItemsInCollection(3);
      expect(result).to.be.an('array').that.is.not.empty;
      expect(result.length).to.be.equal(1);
    ...
    it('get owner of collection - valid unverified', async () => {
      ...
      expect(collectionOwner).to.be.equal(ACCOUNTS[0].address);
    });
    ...
    it('get owner of item collection - unverified', async () => {
      ...
      const itemId = await CONTRACT.connect(ACCOUNTS[0])._getItemId(2, ACCOUNTS[9].address, ACCOUNTS[2].address);
