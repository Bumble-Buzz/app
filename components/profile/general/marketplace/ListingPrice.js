...
const IDENTIFIER = 'listing_price';
const DIALOG = { title: '', content: () => {} };

export default function ListingPrice({ isLoading, setLoading, account, setAccount }) {
  ...
  const depositAction = async (e, _value) => {
    ...
    try {
      ...
      // deposit incentives
      const val = await contract.setMarketplaceListingPrice(ethers.utils.parseEther(_value.toString()));
  ...
  const deposit = async (e) => {
    ...
    DIALOG.title = 'Update listing price';
