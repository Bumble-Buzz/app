...
const ACCOUNT_IDENTIFIER = 'collection_commission';

export default function CollectionCommissionClaim({ isLoading, setLoading, setAccount }) {
  ...
  const claim = async (e) => {
    ...
    try {
      ...
      // claim rewards
      const val = await contract.claimCollectionCommissionRewardUserAccount();
