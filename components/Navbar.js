    ...
    if (isNavOpen) {
      return (
        <div className="absolute right-0 mt-2 py-2 w-48 bg-white rounded-lg shadow-xl">
          <Link href='/'>
            {ROUTER.pathname == '/' ?
              <a className="block px-4 py-2 my-1 text-gray-100 bg-gray-900 font-medium">Mint</a> :
              <a className="block px-4 py-2 my-1 text-gray-800 hover:bg-gray-900 hover:text-gray-100 hover:font-medium">Mint</a>
            }
          </Link>
          <Link href='/my-nft'>
      ...
      <div className="md:flex items-center justify-between py-2 px-8 md:px-12">
        <div className="flex justify-between items-center">
          <div className="text-2xl font-bold text-gray-800 md:text-3xl">
            <Link href='/'><a>Avaxocado</a></Link>
          </div>
          <div onClick={handleClick} className="relative z-10 md:hidden">
        ...
        <div className="flex flex-col md:flex-row hidden md:block -mx-2">
          <Link href='/'>
            {ROUTER.pathname == '/' ?
              <a className="text-gray-100 bg-gray-900 font-medium rounded py-2 px-2 md:mx-2">Mint</a> :
              <a className="text-gray-800 rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">Mint</a>
            }
          </Link>
          <Link href='/my-nft'>
            {ROUTER.pathname == '/my-nft' ?
