  ...
  const filterConfig = [
    {
      name: 'type',
      label: 'Type',
      component: (<ExploreTypeFilter items={
        [
    ...
    },
    {
      name: 'price',
      label: 'Price',
      component: (<ExplorePriceFilter items={
        [
    ...
    },
    {
      name: 'collections',
      label: 'Collections',
      component: (<ExploreCollectionsFilter collectionInit={collectionInit} />)
    },
    {
      name: 'categories',
      label: 'Categories',
      component: (<ExploreCategoriesFilter collectionInit={collectionInit} />)
    }
  ];
