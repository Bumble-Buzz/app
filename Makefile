...
build-push-kind:
	...
	docker tag nft-marketplace:latest 817932929274.dkr.ecr.us-east-1.amazonaws.com/nft-marketplace:latest
	docker push 817932929274.dkr.ecr.us-east-1.amazonaws.com/nft-marketplace:latest
